"""
Django settings for luapol_project project.
...
INSTALLED_APPS = [
    ...
    'luapol_app.apps.LuapolAppConfig',
]
...
ROOT_URLCONF = 'luapol_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'luapol_app/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'luapol_project.wsgi.application'
